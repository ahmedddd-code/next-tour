  ...
  return (
    <div id="search" className="section-shell relative z-20 -mt-24 scroll-mt-24">
      <form onSubmit={submit} className="rounded-[28px] bg-white p-4 shadow-[0_25px_70px_rgba(7,29,52,.16)] md:p-6">
        <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr_1fr_1fr_auto]">
          ...
          <button className="flex min-h-16 items-center justify-center gap-2 rounded-2xl bg-brand px-7 font-extrabold text-white transition hover:bg-brand-dark hover:shadow-lg hover:shadow-brand/25"><Search className="size-5" /> Найти</button>
        </div>
      </form>
    </div>
  );
