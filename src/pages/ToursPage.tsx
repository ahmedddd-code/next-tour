...
export function ToursPage() {
  ...
  const filteredTours = useMemo(() => filterAndSortTours(tours, filters), [tours, filters]);
  ...
  return <main className="min-h-screen bg-[#f7faf8]">
    ...
    <div className="section-shell grid gap-7 py-12 lg:grid-cols-[280px_1fr]">
      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">{filteredTours.map(tour => <TourCard key={tour.id} tour={tour}/>)}</div>
