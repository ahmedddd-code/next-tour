...
function ChatContent() {
  ...
  const { conversations, currentConversationId, sendUserMessage, respondToCloseRequest, startNewConversation, setUserTyping, error, pendingUserMessages } = useSupportChat();
